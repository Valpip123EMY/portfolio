...
const kpis = [
  {
    ...
    description: 'Independent and collaborative research initiatives'
  },
  {
    value: 6,
    suffix: '+',
  ...
  },
  {
    ...
    description: 'Machine learning and data science domains'
  },
  {
    value: 2,
    suffix: '+',
    label: 'Years Experience',
    description: 'Professional development and academic research'
  },
];
